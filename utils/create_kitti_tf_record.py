...
parser.add_argument('--classes_to_use', default='car ,van ,truck ,pedestrian ,cyclist ,tram,dontcare', help='KITTI中需要检测的类别')
...
def prepare_example(image_path, annotations):
    ...
    example = tf.train.Example(features=tf.train.Features(feature={
        'img/height': feature_parse.int64_feature(height),
        'img/width': feature_parse.int64_feature(width),
        'img/filename': feature_parse.bytes_feature(image_path.encode('utf8')),
        'img/source_id': feature_parse.bytes_feature(image_path.encode('utf8')),
        'img/key/sha256': feature_parse.bytes_feature(key.encode('utf8')),
        'img/encoded': feature_parse.bytes_feature(encoded_png),
        'img/format': feature_parse.bytes_feature('png'.encode('utf8')),
        'img/object/bbox/xmin': feature_parse.float_list_feature(xmin_norm),
        'img/object/bbox/xmax': feature_parse.float_list_feature(xmax_norm),
        'img/object/bbox/ymin': feature_parse.float_list_feature(ymin_norm),
        'img/object/bbox/ymax': feature_parse.float_list_feature(ymax_norm),
        'img/object/class/text': feature_parse.bytes_list_feature(classes_text),
        'img/object/difficult': feature_parse.int64_list_feature(difficult_obj),
        'img/object/truncated': feature_parse.float_list_feature(
...
def convert_kitti_to_tfrecords(data_dir, output_path, classes_to_use,
    ...
    train_writer = tf.io.TFRecordWriter(output_path + 'image_2.tfrecord')
